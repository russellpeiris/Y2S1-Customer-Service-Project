		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="view-tickets.jsp"> <i class="fa fa-dashboard"></i>
				...
				<div class="row">
					<div class="col-xs-7  ">
						...
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<!-- form start -->
							<form role="form" action="createticket" method="post">
								<div class="box-body">
									...
									<div class="form-group" style="margin-top: 9%;">
										...
										<div class="col-sm-8">
											<select class="form-control" name="priority" required>
												<option value="" disabled selected>Select Ticket
													Priority</option>
									...
									<div class="form-group" style="margin-top: 18%">
										...
										<div class="col-sm-8">
											<select class="form-control" name="category" required>
												...
												<option value="User Account Issues">User Account
													Issues</option>
									...
									<div class="form-group" style="margin-left: %; margin-top: 27%">
										<div class="box-body pad">
											...
											<textarea id="editor1" name="issue" rows="10" cols="80"
