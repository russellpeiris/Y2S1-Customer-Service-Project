...
<head>
  ...
  <title>Delete Your Ticket</title>
...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                  <a href="../index.jsp"><button class="btn btn-danger btn-round" style="width: 100%">Log out</button></a>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li >
          <a href="view-tickets.jsp">
            <i class="fa fa-dashboard"></i> <span>Tickets</span>
          </a>
        </li>
        <li class="active">
          <a href="create-ticket.jsp">
            <i class="fa fa-list-alt"></i> <span>Create New Ticket</span>
          </a>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-xs-7  ">
         ...
         <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title" style="color: red;"><b>Delete Your Ticket</b></h3>
            </div>
            ...
            <form role="form" action="deletetkt" method = "post">
              <div class="box-body">
                <div class="form-group">
                 
                    <label for="inputEmail3" class="col-sm-3 control-label">Ticket ID</label>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Ticket Category</label>
                  ...
                  <div class="form-group" style="margin-left: %; margin-top: 27%">
                      ...
                      <textarea id="editor1" name="issue" rows="10" cols="80" readonly>
                        <%=issue %>                      
                      </textarea>
  						
  					</div>
  					<input type = "submit" name = "delete" value="Delete Ticket" onclick="return confirm('You are about to delete this Ticket!')">
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2014-2019 <a href="https://adminlte.io">Ticketing</a>.</strong> All rights
      reserved.
    </footer>
